...
export const emotionList = ['微笑', '撇嘴', '色', '发呆', '得意', '流泪', '害羞', '闭嘴', '睡', '大哭',
...
export const emotionMap = emotionList.reduce((acc, emotion, index) => {
    acc[emotion] = `https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/${index}.gif`;
    return acc;
}, {});

export function parseEmotions(text, size=20) {
